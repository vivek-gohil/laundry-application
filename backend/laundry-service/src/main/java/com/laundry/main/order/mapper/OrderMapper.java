...
public interface OrderMapper {
  ...
  @Mapping(target = "customerName", source = "customer")
  @Mapping(target = "mobile", source = "customer.mobile", qualifiedByName = "maskMobile")
  @Mapping(
      target = "status",
      expression = "java(order.getStatus() == null ? null : order.getStatus().name())")
  ...
  default ServiceMaster mapServiceIdToService(Long serviceId) {
  ...
  default Long mapServiceToServiceId(ServiceMaster service) {

    return service == null ? null : service.getServiceId();
  }

  default String mapCustomerName(Customer customer) {
