...
public class PaymentController {
  ...
  public ResponseEntity<ApiResponse<PaymentResponse>> createPayment(
      @Parameter(description = "Payment create request", required = true) @Valid @RequestBody
          PaymentRequest request) {

    return ResponseEntity.status(HttpStatus.CREATED)
        .body(
            ApiResponse.success(
                "Payment created successfully.", paymentService.createPayment(request)));
  }

  @GetMapping("/{paymentId}")
  @Operation(
      summary = "Get payment by id",
      description = "Returns payment details for a given payment id")
  public ResponseEntity<ApiResponse<PaymentResponse>> getPaymentById(
      @Parameter(description = "Payment id", required = true) @PathVariable Long paymentId) {

    return ResponseEntity.ok(
        ApiResponse.success(
            "Payment fetched successfully.", paymentService.getPaymentById(paymentId)));
  }

  @GetMapping("/order/{orderId}")
  @Operation(
      summary = "Get payments by order id",
      description = "Returns all payments associated with a given order")
  public ResponseEntity<ApiResponse<List<PaymentResponse>>> getPaymentsByOrderId(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Payments fetched successfully.", paymentService.getPaymentsByOrderId(orderId)));
  }
  ...
  public ResponseEntity<ApiResponse<List<PaymentResponse>>> getAllPayments() {
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Payments fetched successfully.", paymentService.getAllPayments()));
  }
}
