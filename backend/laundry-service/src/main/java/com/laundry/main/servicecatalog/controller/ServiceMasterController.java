...
public class ServiceMasterController {
  ...
  public ResponseEntity<ApiResponse<ServiceMasterResponse>> createService(
      @Parameter(description = "Service create request") @Valid @RequestBody
          ServiceMasterRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(
            ApiResponse.success(
                "Service created successfully", serviceMasterService.createService(request)));
  }
  ...
  public ResponseEntity<ApiResponse<ServiceMasterResponse>> getServiceById(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Service fetched successfully", serviceMasterService.getServiceById(serviceId)));
  }
  ...
  public ResponseEntity<ApiResponse<List<ServiceMasterResponse>>> getAllServices() {
    return ResponseEntity.ok(
        ApiResponse.success(
            "Services fetched successfully", serviceMasterService.getAllServices()));
  }
  ...
  public ResponseEntity<ApiResponse<ServiceMasterResponse>> updateService(
      @Parameter(description = "Service id") @PathVariable Long serviceId,
      @Parameter(description = "Service update request") @Valid @RequestBody
          ServiceMasterRequest request) {
    return ResponseEntity.ok(
        ApiResponse.success(
